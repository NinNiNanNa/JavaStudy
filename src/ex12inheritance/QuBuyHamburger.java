...
햄버거를 주문시 기본가격 혹은 세트가격으로 출력할 수 있도록 프로그램을 구현하시오.
...
class Burger {
	...
	private String name;
	private int price;
	private String patty, sauce, vegetable;
...
class HamburgerPrice {
	...
	//기본가격계산
	public int payPrice() {
		int basicPrice = burger.getPrice() + COKE + POTATO;
		return basicPrice;
	}
...
class SetPrice extends HamburgerPrice {	
	...
	@Override
	public int payPrice() {
		int setPrice = super.payPrice() - 500;
		return setPrice;
	}
	...
	public void showPrice() {
		burger.showPrice();
		System.out.println("세트결제금액 : "+ payPrice());
		System.out.println("================================");
	}
}
