...
public class E03CallByValue {
	...
	public static void callByValue(int fNum, int sNum) {
		/*
		Swap(교환)
		: 두개의 변수가 할당받은 값을 서로 교환하는 것을 말한다.
		...
		*/
		...
		fNum = sNum;
		sNum = temp;
		//해당 메서드 내에서는 값의 교환이 완료되었기 때문에 출력결과2 : 200, 100 
