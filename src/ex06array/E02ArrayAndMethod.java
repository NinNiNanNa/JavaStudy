...
public class E02ArrayAndMethod {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		배열명을 인수로 전달하는 것은 배열의 참조값(주소값)을 전달하는 것으로 배열 자체가 전달되지 않는다.
		아래 출력문에서는 배열 인스턴스의 참조값(주소값)이 출력된다. 
		*/
		...
		*/
		...
		다시 반환받았으므로 결국 동일한 배열을 참조하게 되어 아래 출력문에서는 동일한 결과가 2번 출력된다. 
		 */
	...
	/*
	매개변수로 전달된 배열의 참조값을 ar로 받게되므로 해당 메서드에서도 동일한 배열을 참조할 수 있게된다.
	즉 main메서드에서 생성한 배열과 동일한 배열을 참조하게된다. 
	*/
