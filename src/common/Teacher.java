...
public class Teacher extends Person {
	...
	*/
	...
	: 객체가 가진 고유한 주소값을 정수형으로 반환해준다.
	  ...
	  정수형 멤버변수는 그냥 사용하면되고, 객체형 멤버변수는 hashCode() 메서드를 통해
	...
	*/
	...
	public int hashCode() {
		...
		*/
		...
		/*
		방법2 : 방법1이 번거롭다면 Objects 클래스의 정적메서드인 hash()를 사용해도된다.
		...
		*/
		...
		// returnCode1, returnCode2 둘다 사용할 수 있다.
		return returnCode2;
	}
	...
	: 객체가 가진 멤버변수의 값을 비교한다.
	  값이 같을때는 true 다를때는 false를 반환하도록 오버라이딩한다.
	*/
	@Override
