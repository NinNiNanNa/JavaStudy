...
/*
do~while문
: 반드시 한번은 실행해야 할 경우 사용하는 반복문으로 조건 검사없이 무조건 한번은 실행된다.
[ 형식 ]
	반복을 위한 변수;
	do{
		실행문;
...
public class E04DoWhile {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		[ 시나리오 ]
		E03 예제의 1~10까지 더하는 수열문제를 do~while문으로 변경하여 구현하시오.
		*/
		// 누적합과 반복을 위한 변수
		int sum = 0;
		int i = 1;
		...
		/*
		[ 시나리오 ]
		1부터 1000까지의 정수중 4의 배수이거나 7의 배수인 수의 합을 구하여 출력하는 프로그램을 작성하시오.
		...
		*/
		...
		/*
		[ 시나리오 ]
		국어, 영어, 수학 점수를 사용자로부터 입력받은 후 평균을 구해
		A~F학점을 판단하여 출력하는 프로그램을 작성하시오.
		단, 사용자가 X,x(대소문자 구분없음)를 입력하면 프로그램이 종료된어야 하며
		do~while문으로 구현해야 한다.
		*/
		...
		do {
			...
			switch문은 조건식은 사용할 수 없고 산술식만 사용할 수 있으므로 99점 혹은 91점을
			10으로 나눈 몫이 9라는 것을 통해 구간을 대체하는 산술결과를 얻을 수 있다.
			*/
		...
		*/
		...
		/*
		[ 연습문제 ]
		다음과 같은 피라미드를 출력하는 프로그램을 do~while문으로 작성하시오.
		*
		**
		***
		****
