...
public class E05For {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
		[ 시나리오 ]
		for문을 이용하여 1~10까지의 정수중 2의배수의 합을 구하는 프로그램을 작성하시오.
		*/
		...
		System.out.println("1~10사이의 2의배수의 합(방법1) : "+ total);
...
//		System.out.println("위 for문에서 선언한 변수 j ="+ j);
		...
		*/
		System.out.println("구구단 출력하기 - 내가한거");
		...
		System.out.println("구구단 출력하기 - 쌤이한거");
		// 단은 2~9까지 증가
		for(int dan=2; dan<=9; dan++) {
			// 수는 1~9까지 증가
			for(int su=1; su<=9; su++) {
		...
		*/
		System.out.println("0,1패턴 출력하기 - 내가한거");
		for(int x=1; x<=4; x++) {
			for(int y=1; y<=4; y++) {
				if(x+y==5) {
					System.out.print("1 ");
		...
		System.out.println("0,1패턴 출력하기 - 쌤이한거");
		for(int x=1; x<=4; x++) {
			for(int y=1; y<=4; y++) {
				if(x+y==5)
					System.out.print("1 ");
