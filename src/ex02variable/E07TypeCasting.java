...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		아래 코드는 자동형변환이 아니다.
		CPU는 int보다 작은자료를 연산할때는 int로 간주하여 진행하고 결과도 int로 변환한다.
...
//		char ch1 = b1;
		...
		명시적 형변환 : 큰 상자의 자료를 작은 상자의 자료형에 할당해야 할때 사용한다.
					 단, 자료의 손실이 있을수 있으므로 필요한 경우에만 사용해야한다.
		*/
		...
		흔히 "원 단위 절석"과 같은 경우에 사용한다.
		*/
		int num3;
		double dl = 3.14;
		num3 = (int)dl;
		System.out.printf("데이터손실 :num3=%d, dl=%.2f %n", num3, dl);
		// 서식문자 사용시 %.2f는 정수는 모두 출력하고, 소수이하는 2자리까지만 표현한다.
		
		/*
		문자는 메모리에 저장시 아스키코드로 저장되므로
		int형과의 연산을 진행한 후 문자로 표현하고 싶다면 char형으로 강제형변환 하면된다.
		*/
		char ch3 = 'A', ch4;
		int num4 = 2;
//		ch4 = ch3 + num4;
