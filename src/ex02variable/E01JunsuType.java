...
public class E01JunsuType {
	...
	public static void main(String[] args) {
	      ...
	      */
	      ...
	      /*
	      100/200의 결과는 0이 나오게 된다. Java에서는 정수와 정수를 연산하면 정수의 결과가 반환된다.
	      ...
	      */
	      ...
	      - byte, short 타입은 게임 캐릭터의 움직임이나 음원파일 등을 표현할때 주로 사용된다.
	      */
	      byte byte1 = 50, byte2 = 55;
	      // byte + byt = int타입의 결과 출력
	      ...
	      */
	      ...
	      이때 접미사(L 혹은 l)을 붙여서 int형의 자료가 아닌 long형의 자료임을 컴파일러이게 알려줘야한다
	      이와같이 할당을 위해 입력되는 숫자도 자료형을 기반으로 메모리에 로드되는데 이를 가르켜 리터럴(literal)이라고 한다.
	      */
